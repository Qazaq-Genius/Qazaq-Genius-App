...
const submitForm = async (e: any, artists: Array<object>, verse: Array<object>) => {
	...
	all_artists.push({name_cyr: formData['artist-cyr'], name_lat: formData['artist-lat']})
	artists.forEach(artist => {
		all_artists.push({name_cyr: artist.cyr, name_lat: artist.lat})
	})
	finalData['artists'] = all_artists

	// album
	finalData['album'] = {name_cyr: formData['album-cyr'], name_lat: formData['album-lat']}
